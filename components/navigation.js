                ...
                <ul className="space-y-5 font-medium navlinks">
                    ...
                    <li className='flex flex-col items-center'>
                        <Link href='/buysms/buynow' className="flex w-full justify-between items-center p-2 text-gray-900 rounded-lg  hover:bg-[#3c567e] group ">
                           <div className='flex'>
                            ...
                            <MdOutlineArrowDropUp onClick={toggleBuySMSDropdown} size={32} className={`ml-2 ${showBuySMSDropdown ? 'rotate-0': "-rotate-90" } `} color='white'/>
                        </Link>
                       {showBuySMSDropdown && (
                        <ul className='text-white  font-oswald  w-40 text-left mt-2'>
                        <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'><Link href={"/buysms/buynow"}
                        >Buy now</Link></li>
                        <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'><Link href={'/buysms/alltransactions'}>All transactions</Link></li>
                    </ul>
                       )}
                    </li>
                    <li className='flex flex-col items-center'>
                        <Link href='/senderids/allsenderids' className="flex w-full justify-between items-center p-2 text-gray-900 rounded-lg  hover:bg-[#3c567e] group">
                           ...
                           <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <MdOutlineArrowDropUp size={32} onClick={toggleSenderIDsDropdown} className={`ml-2 ${showSenderIDsDropdown ? 'rotate-0': "-rotate-90" } `} color='white'/>
                        </Link>
                        {showSenderIDsDropdown &&(
                            <ul className='text-white font-oswald  w-40 text-left mt-2'>
                            <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'>
                                <Link href='/senderids/allsenderids'>All Sender IDs</Link>
                            </li>
                            <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'><Link href="/senderids/requestsenderids">Request&nbsp;for&nbsp;Sender&nbsp;IDs</Link></li>
                        </ul>
                        )}
                    </li>

                    <li className='flex flex-col items-center'>
                        <Link href='/reports/deliveryReport' className="flex justify-between items-center w-full p-2 text-gray-900 rounded-lg  hover:bg-[#3c567e] group">
                           ...
                           <svg width="23" height="28" viewBox="0 0 23 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <MdOutlineArrowDropUp size={32} onClick={toggleReportsDropdown} className={`ml-2 ${showSenderIDsDropdown ? 'rotate-0': "-rotate-90" } `} color='white'/>
                        </Link>
                        {showReportsDropdown && (
                           <ul className='text-white  font-oswald  w-40 text-left mt-2'>
                           <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'><Link href={"/reports/deliveryReport"}>My Delivery Reports</Link></li>
                           <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'>Download Reports</li>
                           <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'>My Delivery Reports</li>
                           <li onClick={()=>{console.log('')}} className='hover:bg-[#3c567e] p-2 rounded-md cursor-pointer'>
                            <Link href='/reports/downloadreports'>Download Reports</Link></li>
                       </ul>
                        )}
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href='/logout' className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-[#3c567e] group">
                            ...
                            <span className="ms-3 text-md md:text-lg text-white">Logout</span>
                        </Link>
                    </li>
                </ul>
                </div>
