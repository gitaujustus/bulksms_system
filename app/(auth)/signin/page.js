    ...
    <div className="min-h-screen flex py-10 items-center justify-center bg-gray-100">
      <div className="bg-[#26364E] text-white p-8 rounded-md shadow-md w-full mx-2 max-w-lg">
        <div className="flex justify-center mb-6">
          <img src="/images/logo.png" className='bg-white rounded-full w-40' alt="Logo" />
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 flex items-center">
            ...
            />
            <div className="mx-2 w-full text-gray-300 text-sm flex flex-wrap justify-between">
              <span>Remember me</span> 
              <Link href="/account/resetpassword" className="underline text-[#ff5c5c]">Forgot Password?</Link>
            </div>
          </div>
        </form>
      </div>
