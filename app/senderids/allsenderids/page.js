  ...
  return (
    <div className="min-h-screen bg-white p-4 rounded-md mt-14 md:mt-0 md:ml-80">
      <div className="flex justify-between mb-4">
        ...
        <button className="bg-red-500 flex items-center text-white px-4 py-2 rounded-md">
        <span>
      ...
      <div className="overflow-x-auto min-h-[50vh]  ">
        <table className="w-full  px-3 table-auto">
          <thead>
            <tr>
              <th className="px-4 py-2 text-start border-l border-gray-400">ID</th>
              <th className="px-4 py-2 text-start border-l border-gray-400">Value</th>
              <th className="px-4 py-2 text-start border-l border-gray-400">Purpose</th>
              <th className="px-4 py-2 text-start border-l border-gray-400">Amount&nbsp;paid</th>
              <th className="px-4 py-2 text-start border-l border-gray-400">Status</th>
              <th className="px-4 py-2 text-start border-l border-gray-400">Created&nbsp;at</th>
            </tr>
          </thead>
          <tbody>
            <tr className='bg-[#F5E0E0] text-sm'>
              <td className="px-4 py-2 border border-gray-400">13372</td>
              <td className="px-4 py-2 border border-gray-400">MEATSOKO</td>
              <td className="px-4 py-2 border border-gray-400">MEATSOKO Bulksms</td>
              <td className="px-4 py-2 border border-gray-400">0</td>
              <td className="px-4 py-2 border border-gray-400"><p className='border border-green-500 text-xs text-green-500 rounded-lg'>READY FOR SENDING</p></td>
              <td className="px-4 py-2 border border-gray-400">2024-04-09 08:50</td>
            </tr>
          </tbody>
        </table>
      </div>
      <div className="flex justify-between border border-gray-400 mt-4">
        <span className='pl-2'>1 row selected</span>
        <div className='flex items-center gap-2'>
          <span className="mx-2">1-1 of 1</span>
            <span>
